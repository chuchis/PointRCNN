...
__C.RCNN.DEEPGCN_CONFIG = edict()
__C.RCNN.DEEPGCN_CONFIG.N_FILTERS = 64
__C.RCNN.DEEPGCN_CONFIG.KERNEL_SIZE = 16
__C.RCNN.DEEPGCN_CONFIG.N_BLOCKS = 20
__C.RCNN.DEEPGCN_CONFIG.CONV = 'mr'
__C.RCNN.DEEPGCN_CONFIG.HEAD = True
__C.RCNN.DEEPGCN_CONFIG.BLOCK = 'res'
__C.RCNN.DEEPGCN_CONFIG.CONSTANT_DILATION = False
__C.RCNN.DEEPGCN_CONFIG.LINEAR_DILATION = True
__C.RCNN.ROT_CONFIG = edict()
__C.RCNN.ROT_CONFIG.DEGREE_RES = 5
__C.RCNN.ROT_CONFIG.OCCUPANCY = False
__C.RCNN.ROT_CONFIG.DROPOUT = .5
__C.RCNN.ROT_CONFIG.CONV_FEAT_MULTIPLIER = 4
__C.RCNN.ROT_CONFIG.NFILTERS = [128, 128, 256, 512]
...
__C.RCNN.REF_CONFIG.N_BLOCKS = 20
__C.RCNN.REF_CONFIG.KERNEL_SIZE = 16
__C.RCNN.REF_CONFIG.N_FILTERS = 64
__C.RCNN.REF_CONFIG.CONSTANT_DILATION = False
__C.RCNN.REF_CONFIG.LINEAR_DILATION = False
__C.RCNN.REF_CONFIG.CONV = 'mr'
__C.RCNN.REF_CONFIG.USE_RCNN_FEATS = False
__C.RCNN.REF_CONFIG.USE_RPN_FEATS = False
__C.RCNN.REF_CONFIG.USE_PROPOSALS = False
