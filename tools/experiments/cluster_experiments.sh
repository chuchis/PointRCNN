...
#sh cluster_rcnn.sh pretrained_offline_deeprefine "20_20" "$@" --pretrained_rpn --gres gpu:v100 --time 200:00:00
#sh cluster_rcnn.sh pretrained_offline_deeprefine "3_3" "$@" --pretrained_rpn --gres gpu:v100 --time 200:00:00 --set RCNN.DEEPGCN_CONFIG.N_BLOCKS 3 --set RCNN.REF_CONFIG.N_BLOCKS 3
